...
const IDS = [
  ...
  // (7,8) shallow ↔ regular ocean
  780, 781, 782, 783, 784, 800, 801, 802, 803, 804, 820, 821, 822, 823, 824, 860, 861, 862, 863, 864,
  // (8,9) regular ↔ deep ocean
  760, 761, 762, 763, 764, 840, 841, 842, 843, 844, 896,
  // Forest cluster tiles (terrain 0 region — 280-284, 320-325, 360-364)
